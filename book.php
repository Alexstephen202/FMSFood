...
<br />
<br />
<div align="center"> <span class="subHead"  style="color:tomato;">Book Food items</span> <br />
  <br />
  <form method="post" action="">
 <table border="0" cellpadding="5" cellspacing="5" class="design" style="background:lightgray;">
...
<tr><td class="labels">Duration : </td><td>
<select name="j" class="fields" required>
<option value="" selected="selected" disabled="disabled">- - timing - -</option>
<option value="bike">30mins</option>
<option value="bike">45mins</option>
<option value="bike">1hour</option>
</select>
</td></tr>
...
<br />
<br />
 <span class="subHead" style="color:white;">Current Food Item<br /></span><br />
...
<th class="ashu">Duration</th><th class="ashu">Total Amount</th><th class="ashu">Date</th><th class="ashu">Status</th>
<th class="ashu">Delete</th> <th class="ashu">Edit</th></tr>
<?php
$u=1;
...
<br />
<a href="home.php" class="link" type="button">HOME</a>
</div>
</body>
